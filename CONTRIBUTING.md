...
- [ ] Реализация загрузчика Яндекс.Музыка
- [ ] Добавление кнопки загрузки во все виды интерфейса
- [ ] Обеспечение 100% покрытия тестами нового кода

## Известные баги

- [ ] "Плавающая" кнопка загрузки в ZvukService
- [ ] При загрузке плейлиста иногда не удается обнаружить сервис в новом окне
